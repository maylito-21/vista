          ...
          <div class="col-12 col-sm-7">
            <div class="row">
              ...
              <div class="col-12 py-2" style="min-height: 55vh;max-height: 55vh;overflow-y: scroll;overflow-x: none;">
                <div class="row">
                  <div class="col-6 col-md-4 col-lg-3" v-for="m in articulosCategoria">
            ...
            <div class="card card-pricing">
              <div class="card-header bg-gradient-dark text-center pt-4 pb-5 position-relative">
                <div class="z-index-1 position-relative">
                  ...
                  <h6 class="text-white">Total compra</h6>
                </div>
              </div>
              ...
              <div class="card-body text-center p-3"
                style="min-height: 40vh;max-height: 40vh;overflow-y: scroll;overflow-x: none; ">
  ...
  methods: {
    ...
    async Datos() {
      try {
        await Promise.all([this.GET_DATA('marcas'), this.GET_DATA('categorias'), this.GET_DATA('articulos')]).then((v) => {
          //   await Promise.all([this.GET_DATA('marcas'), this.GET_DATA('categorias'), this.GET_DATA('articulos'), this.GET_DATA('inventarios')]).then((v) => {
    ...
    async Save() {
      if (this.totalCarrito == 0) {
        this.$swal.fire({
          title: "¡Atención!",
          text: "No hay artículo para comprar",
          icon: 'info',
        })
      } else {
        this.load = true;
    ...
    Clean() {
      ...
      if (this.carrito.length == 0) {
        this.$swal.fire({
          title: "¡Atención!",
          text: "No hay artículos de compra",
          icon: 'info',
        }
