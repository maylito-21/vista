        ...
        <AdminTemplate :page="page" :modulo="modulo">
            <div slot='body'>
                <div class="row justify-content-end">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <h4 class="text-center">Listado de categorías</h4>
                            <hr class="horizontal dark mt-0;" style="margin-top: -1px;">
                            <div class="card-body">
                                <!-- <h6>totalItems:{{ totalItems }}</h6>
                                <h6>numeroPaginas: {{ numeroPaginas }}</h6>
                                <h6>itemsPorPaginas{{ itemsPorPaginas }}</h6>
                                <h6>pagina:{{ pagina }}</h6>
                                <button @click="siguientePagina">Click</button>
                                <h6>{{ listPagina }}</h6> -->
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            <li class="page-item"><a class="page-link" href="#" @click="paginaAnterior"
                                                    style="padding: 0 50px 0 50px; border-radius: 10px!important; ">Anterior</a>
                                            </li>
                                            <li v-for="paginax in totalPaginas()" class="page-item"><a class="page-link"
                                                    href="#" @click="paginaEspecifica(paginax)">{{ paginax }}</a></li>
