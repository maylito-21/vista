      ...
      <div slot="body">
        <div class="row justify-content-end">
          <div class="col-lg-4 col-6" style="margin-top: -24px;">
            ...
            <input type="text" class="form-control" @keyup="buscarItem" v-model="palabraBusqueda" placeholder="Digita el nombre" style="padding: 4px;">
          </div>
          ...
          <div class="col-12">
            <div class="card">
              <h4 class="text-center">Listado de artículos</h4>
                  ...
                  <div>
                    <table class="table table-hover">
                      <thead>
                        ...
                        <th class="py-1 px-1">Nombre</th>
                        <th class="py-1 px-1">CodeBar</th>
                        <th class="py-1 px-1">Marca</th>
                        <th class="py-1 px-1">Categoría</th>
                        <th class="py-1 px-1">Stock Min</th>
                        <th class="py-1 px-1">P. Compra</th>
                        <th class="py-1 px-1">P. Venta</th>
                        <th class="py-1 px-1 text-center">Opciones</th>
                      </thead>
                      <tbody>
                        <tr v-for="(m, i) in listPagina">
                          ...
                          <td class="py-1 px-1">{{ m.stock_minimo }} {{ m.medida.codigo }}</td>
                          <td class="py-1 px-1">${{ m.compra }}</td>
                          <td class="py-1 px-1">${{ m.venta }}</td>
