                  ...
                  <div class="col-12 col-md-5 mx-auto">
                    ...
                    <div class="d-flex justify-content-between">
                      <div class="mx-1">
                        ...
                        <h5>{{Number(model.compra).toFixed(2)| currency('$')}}</h5>
                      </div>
                      <div class="mx-1">
                        <h6 class="mb-0 mt-3">Precio Venta</h6>
                        <h5>{{Number(model.venta).toFixed(2)| currency('$')}}</h5>
                      </div>
                      <div class="mx-1">
                        <h6 class="mb-0 mt-3">G. Unitaria</h6>
                        <h5>{{Number(model.venta - model.compra).toFixed(2)| currency('$')}}</h5>
                      </div>
                    </div>
                    <span class="badge " :class="[model.stock<=model.stock_minimo?'badge-danger':'badge-success']"
                      ><i class="fas fa-archive" aria-hidden="true"></i> {{model.stock}} en Stock</span
                    >
                    <br />
                    <div class="d-flex justify-content-between">
                      <div class="mx-1">
                        <h6 class="mb-0 mt-3">Inversion</h6>
                        <h5>{{Number(model.inversion).toFixed(2)| currency('$')}}</h5>
                      </div>
                      <div class="mx-1">
                        <h6 class="mb-0 mt-3">Valorizado</h6>
                        <h5>{{Number(model.valorizado).toFixed(2)| currency('$')}}</h5>
                      </div>
                      <div class="mx-1">
                        <h6 class="mb-0 mt-3">Ganancia</h6>
                        <h5>{{Number(model.ganancia).toFixed(2)| currency('$')}}</h5>
                      </div>
                    </div>
                      ...
                      <table class="table align-items-center mb-0 table-sm">
                        <thead>
                          <tr>
                            ...
                            <th
                              class="text-end text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2"
                            >
                              Eliminar
                            </th>
                        ...
                        <tbody>
                          <tr v-for="(m, i)  in model.inventarios">
                            <td >
                              <div class="d-flex py-1 px-1">
                                <div class="text-xxs">{{i + 1}}</div>
                              </div>                            
                            </td>
                            <td >
                              <div class="d-flex py-1 px-1">
                                <div class="text-xxs">{{ formatDateEN(m.created_at) }}</div> 
                              </div>                            
                            </td>
                            <td>
                            ...
                            <td class="text-xxs">{{Number(m.compra).toFixed(2)| currency('$')}}</td>
                            <td class="align-middle text-sm text-xxs">{{Number(m.venta).toFixed(2)| currency('$')}}</td>
